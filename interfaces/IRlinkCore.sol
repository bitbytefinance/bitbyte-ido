...
interface IRlinkCore {
     ...
     */
    function addRelation(address _child, address _parent) external returns(uint256);  // 添加邀请人
     ...
     */
    function parentOf(address account) external view returns(address);  // 查询邀请人奖励
